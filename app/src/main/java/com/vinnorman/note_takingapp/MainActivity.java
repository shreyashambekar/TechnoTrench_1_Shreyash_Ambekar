package com.vinnorman.note_takingapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void createNoteView(final Note note) {
        ...
        TextView updateButton = noteView.findViewById(R.id.Button_upadate_note);
    ...
    private void showUpdateDialog(final Note note) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("Update Note");

        View dialogView = getLayoutInflater().inflate(R.layout.dialoge_update, null);
